...
<body>
  <div class="sidebar">
    <h3>📋 Menu Utama</h3>
    <ul>
      <li><a href="<?php echo e(route('tasks.index')); ?>">🗂 Daftar Pengingat</a></li>
      <li><a href="<?php echo e(route('daily-notes.index')); ?>">📝 Catatan Harian</a></li>
      <li><a href="<?php echo e(route('account.settings')); ?>">⚙ Pengaturan Akun</a></li>
    </ul>
  </div>
  ...
  <div class="main-content">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-number"><?php echo e($taskCount ?? 0); ?></div>
    ...
    <div class="card">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('tasks.create')); ?>" class="create-btn">+ Tambah Jadwal</a>
      </div>

      <?php if(!empty($recentTasks) && count($recentTasks) > 0): ?>
        <?php $__currentLoopData = $recentTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="task-item <?php echo e($task->status === 'completed' ? 'completed' : ''); ?>">
            <div>
              <strong><?php echo e($task->title); ?></strong><br>
              <small>
                📂 <?php echo e(ucfirst($task->category)); ?> •
                <?php if($task->due_date): ?>
                  📅 <?php echo e(\Carbon\Carbon::parse($task->due_date)->translatedFormat('d F Y')); ?>
            ...
            <a href="<?php echo e(route('tasks.show', $task->id)); ?>" class="detail-btn">🔍 Detail</a>
          </div>
...
<?php /**PATH C:\xampp\htdocs\web_project1\resources\views/dashboard.blade.php ENDPATH**/ ?>